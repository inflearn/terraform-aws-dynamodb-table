...
resource "aws_appautoscaling_policy" "table_read_policy" {
  ...
  target_tracking_scaling_policy_configuration {
    ...
    scale_in_cooldown  = try(var.autoscaling_read.scale_in_cooldown, var.autoscaling_defaults["scale_in_cooldown"])
    scale_out_cooldown = try(var.autoscaling_read.scale_out_cooldown, var.autoscaling_defaults["scale_out_cooldown"])
    target_value       = try(var.autoscaling_read.target_value, var.autoscaling_defaults["target_value"])
  }
}
...
resource "aws_appautoscaling_policy" "table_write_policy" {
  ...
  target_tracking_scaling_policy_configuration {
    ...
    scale_in_cooldown  = try(var.autoscaling_write.scale_in_cooldown, var.autoscaling_defaults["scale_in_cooldown"])
    scale_out_cooldown = try(var.autoscaling_write.scale_out_cooldown, var.autoscaling_defaults["scale_out_cooldown"])
    target_value       = try(var.autoscaling_write.target_value, var.autoscaling_defaults["target_value"])
  }
}
